    ...
    return (
        <div id="login">
            ...
            <Link to="/edp-unblock" className="temp-disclaimer" id="edp-unblock-ad">
                ...
                <span className="edp-unblock-ad-content">Installez l'extension EDP Unblock pour accéder en continu à Ecole Directe Plus ! <span className="edpu-explanation">Ecole Directe Plus a besoin de son extension pour accéder au contenu fourni par l’API d’EcoleDirecte.</span></span>
                <span className="edp-unblock-ad-link">En savoir plus</span>
            </Link>
