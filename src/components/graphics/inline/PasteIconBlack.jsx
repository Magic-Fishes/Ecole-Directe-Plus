...
import "../graphics.css"
export default function PasteIconBlack ({ className="", id="", alt }) {
    return (
<svg className={className} id={id} xmlns="http://www.w3.org/2000/svg" version="1.1" id="Icons" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve">
<title>{alt}</title>
<style type="text/css">
