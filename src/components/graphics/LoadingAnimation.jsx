...
export default function LoadingAnimation ({ className="", id="", alt, ...props }) {
    return (
<svg aria-label={alt} className={className} id={id} xmlns="http://www.w3.org/2000/svg" style={{"margin": "auto", "background-image": "none", "display": "block", "shape-rendering": "auto"}} viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
