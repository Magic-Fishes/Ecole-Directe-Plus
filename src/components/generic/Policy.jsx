...
export default function Policy() {
    ...
    const legalNotice = <ul>
        <h3 className="part-header">Ecole Directe Plus utilise des données provenants des serveurs d'EcoleDirecte, nous héritons ainsi de leur politique de confidentialité qui sont les suivantes :</h3>
