                    ...
                    embeds: [
                        {
                            ...
                            author: {
                                ...
                                icon_url: ((isAnonymous || !activeUser) ? (() => { console.log("POISSON ZEBRE") ; return "https://i.ibb.co/CKmD9z8/poisson-z-bre.jpg" })() : (() => {console.log("https://server.ecoledirecte.neptunium.fr/api/user/avatar?url=https:" + activeUser.picture) ; return "https://server.ecoledirecte.neptunium.fr/api/user/avatar?url=https:" + activeUser.picture})())
                            },
