...
export default function Lab({ fetchGrades }) {
    ...
    return (
        <div id="lab-page">
                ...
                <h3 id="lab-app-loading">WalkingCanardman</h3>
                <WalkingCanardman style={{ display: "block", height: "200px", margin: "0 auto" }} />
                <h3>ShiningDiv</h3>
                ...
                <h3>Notifications</h3>
                <div>
                    <Button value="create notification" onClick={() => {addNotification(<h1>NOTIFICATION TRÈS PERTINENTE</h1>)}} />
                </div>
                ...
                <h3>UseEffectTest</h3>
                <Button value="useEffect TEST" onClick={() => { setTestState((old) => !old) }} />
                <h3>GameOfLife</h3>
