                ...
                <MoveableContainer>
                    {!isTabletLayout
                        ...
                        : <div className="results-options-container">
                            <DropDownMenu name="periods" options={grades ? Object.keys(grades) : [""]} displayedOptions={grades ? Object.values(grades).map((period) => period.name) : [""]} selected={selectedPeriod} onChange={setSelectedPeriod} />
