...
export default function Notebook({ }) {
    ...
    return <>
        {homeworks ? Object.keys(homeworks).sort().map((el, i) => {
            ...
            return <div key={homeworks[el].id} className={`notebook-day ${location.hash.split(";")[0].slice(1) === el ? "selected" : ""}`}>
                ...
                <div className="tasks-container">
                    {homeworks[el].map((task, taskIndex) => <Link to={`#${el}`} className="task">
